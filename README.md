...
1- wap to print no. from 1 to 5 using for loop.

2- wap to print no from 10 to 1 using for loop.

3- wap to print odd no from 1 to 10 using for loop.

4- wap to print even no between 1 and 10 using for loop.
...
8 - wap to accept empno empname and basic_salary then calculate hra (15% of basic salary) , da (25% of basic) , ta (55% of basic) , total salary(basic_Salary + hra + da+ ta)

9 wap to accept a number and print whether it is a natural no.

10 wap to accept a number and print the armstrong no.

11 wap to print prime no between 1 and 20
nested for loop.

12 wap to print the pattern as given below
	1	2	3
	1	2	3
	1	2	3
using nested for loop.

13-wap to print the pattern as given below
	1	1	1
	2	2	2
	3	3	3
using nested for loop.

14-wap to print the pattern as given below
	1	
	1	2
	1	2	3

	15-wap to print the pattern as given below
	*	
	*	*
	*	*	*

	16- wap to print the pattern as given below
	1	2	3	
	1	2
	1

	17- wap to print the pattern as given below
	1	3	5	
	1	3	5
	1	3	5

	18- wap to print the pattern given below
	1
	1	3	
	1	3	5
	...
	3- function not returning any value and with no parameters.

	4- function not returning any value and with parameters.

	5 - create a function calculate with 2 integer parameters and calculate and display the addition of 2 no.

	//2- function not returning any value and with parameters.

	3- function returning a value and with parameters
	...
	4- function returning a value and  without parameters

	5- create function 

	6 - example of calling 3 differnt functions from the main function

	7 - example of function prototype

	8 example of pass by value 

	9 - create a function calculate with 3 parameters 
calculate ( int n1, int n2 , char op)
and display the result . (do with without return type and with return type.)


10 - create a function calculatefactorial(int num) to  calculate and display factorial of a number.


11 - create a  function displaytable(int num) to display the table of that number.

12 - create a function checkprimeno(int num) to check and display wheter the number is prime or not.


31 - march(array)


1- create a integer array of 5 elements to store 5 no.  then display the elements of an array.
...
14 repeat the above program and do it it binary search.(accept the no. in ascendion order)
...
1-//wap to accept rollno, studentname, marks of 5 subject(in an array)
//then display total,per,grade.
...
2-wap to accept number of short datatype

3-wap to accept number of int datatype

4-wap to accept number of long datatype

5-wap to accept number of float datatype

6-wap to accept number of double datatype

7-wap to accept number of boolean datatype

8-wap to accept number of char datatype

9-String class

10 -wap to create a integer of 5 elements to store 5 numbers
...
13 - array with initilization

14 - create a 2 array of 2 rows and 3 columns in java

15 wap to create 2 d array of 3 rows and 3 columns to store 9 numbers
16 - wap to find length of an array

17 - wap to use arraycopy method to copy some characters from one array to another array.

18 - wap to use copyofrange method of array class to copy some characters from one array to another 
...
3 wap to print no. from 1 to 10 using while loop
...
7 - wap to println output like given below using nested for loop.
	...
	*	*	*
	...
	8 - wap to create an array of 3 element and display the array element using for each loop.
	...
	12 - user defined function in java
wap to create a function sayhello 

13 - create a non static sayhello method 

14- function with arguments and no return type

15 function with return type and with arguments

16 function with returning value and no parameters
...
4 - create a class car having field color, make , brand and methods getdata(), showdata() and startenginge
...
7-create a class employee having fields empno,empname, designation, salary and method getemployeedata and displayemployeedata

8-create a class book having fields bookid,bookname,author,price and methods getbookdata and display bookdata

9- create a class dog having fields breed , height and color and methods getdata and showdata and bark.
...
2 class having constructor and method with the same name of 
...
3-ex calling parameterized constrctor from default constructor using this key word

4-constructor chaning example

5-create a class customer having field custno and custname and method getdata and showdata

6-to refer to current class method

7-to invoke current class constructor

8-constructor chaining

9-Java Program to demonstrate the use of static variable  

10-In this example, we have created an instance variable named count which is incremented in the constructor. Since instance variable gets the memory at the time of object creation, each object will have the copy of the instance variable. If it is incremented, it won't reflect other objects. So each object will have the value 1 in the count variable.

11-As we have mentioned above, static variable will get the memory only once, if any object changes the value of the static variable, it will retain its value.

12-Java static method Example of static method

13-Another example of a static method that performs a normal calculation

14-The static method can not use non static data member or call non-static method directly.
this and super cannot be used in static context.

	15-Example of static block
	...
	17-Java Program to create and call a default constructor  

	18-Example of default constructor that displays the default values

	19-The parameterized constructor is used to provide different values to distinct objects. However, you can provide the same values also.
Example of parameterized constructor


20-Java Program to demonstrate the use of the parameterized constructor.  

21-Example of Constructor Overloading

22-In this example, we are going to copy the values of one object into another using Java constructor.

23-Copying values without constructor
...
1-Let's understand the problem if we don't use this keyword by the example given below:

2-If local variables(formal arguments) and instance variables are different, there is no need to use this keyword like in the following program:
...
5-Calling parameterized constructor from default constructor:

6-this: to pass as an argument in the method
...
3-  create  a parent class person having field name and address and methods getpersondata and displaypersondata  and  create a derived class student 
inherited from person class having additional fields rno and marks. and methods getstudentddata and displaystudent data.
...
19 - april(overloading)

1-In this example, we are creating static methods so that we don't need to create instance for calling methods.

2-In this example, we have created two methods that differs in data type. The first add method receives two integer arguments and second add method receives two double arguments.

3-In this example, we have created two methods that differs in data type. The first add method receives two integer arguments and second add method receives two double arguments.

4-In java, method overloading is not possible by changing the return type of the method only because of ambiguity. Let's see how ambiguity may occur:

5-Can we overload java main() method?
Yes, by method overloading. You can have any number of main methods in a class by method overloading. But JVM calls main() method which receives string array as arguments only. Let's see the simple example:

6-Example of Method Overloading with TypePromotion

7-Example of Method Overloading with Type Promotion if matching found
If there are matching type arguments in the method, type promotion is not performed.

8-Example of Method Overloading with Type Promotion in case of ambiguity
If there are no matching type arguments in the method, and each method promotes similar number of arguments, there will be ambiguity.

(inheritance)


1-As displayed in the above figure, Programmer is the subclass and Employee is the superclass. The relationship between the two classes is Programmer IS-A Employee. It means that Programmer is a type of Employee.
...
5-To reduce the complexity and simplify the language, multiple inheritance is not supported in java.
...
1-In this example, we have created the reference of Operation class in the Circle class.

2-In this example, Employee has an object of Address, address object contains its own informations such as city, state, country etc. In such case relationship is Employee HAS-A address.
...
2-In this example, we have defined the run method in the subclass as defined in the parent class but it has some specific implementation. The name and parameter of the method are the same, and there is IS-A relationship between the classes, so there is method overriding.

3-Consider a scenario where Bank is a class that provides functionality to get the rate of interest. However, the rate of interest varies according to banks. For example, SBI, ICICI and AXIS banks could provide 8%, 7%, and 9% rate of interest.

4-ex : 3 create a class account having field accountno , bal and  method deposit and withdrawl.
create a subclass saving and override the deposit and withdrawl method.

5-ex 4 create a class account having field accountno , bal and  method deposit and withdrawl.
...
1-In this process, an overridden method is called through the reference variable of a superclass. The determination of the method to be called is based on the object being referred to by the reference variable.

2-example of runtime polymorphism using account, saving and current class

(upcasting)

1-If the reference variable of Parent class refers to the object of Child class, it is known as upcasting. For example:

2-In this example, we are creating two classes Bike and Splendor. Splendor class extends Bike class and overrides its run() method. We are calling the run method by the reference variable of Parent class. Since it refers to the subclass object and subclass method overrides the Parent class method, the subclass method is invoked at runtime.

3-This example is also given in method overriding but there was no upcasting.

4-Java Runtime Polymorphism Example: Shape

5-Java Runtime Polymorphism Example: Animal

6-Java Runtime Polymorphism with Data Member
In the example given below, both the classes have a data member speedlimit. We are accessing the data member by the reference variable of Parent class which refers to the subclass object. Since we are accessing the data member which is not overridden, hence it will access the data member of the Parent class always.
Rule: Runtime polymorphism can't be achieved by data members.

7-Java Runtime Polymorphism with Multilevel Inheritance


22-april(covariant)

1-Simple example of Covariant Return Type
...
1-Usage of Java Super keyword
 ...
 2-In the above example, Animal and Dog both classes have a common property color. If we print color property, it will print the color of current class by default. To access the parent property, we need to use super keyword.

 3-super can be used to invoke parent class method
The super keyword can also be used to invoke parent class method. It should be used if subclass contains the same method as parent class. In other words, it is used if method is overridden.

4-In the above example Animal and Dog both classes have eat() method if we call eat() method from Dog class, it will call the eat() method of Dog class by default because priority is given to local.

5-To call the parent class method, we need to use super keyword.
 super is used to invoke parent class constructor.
The super keyword can also be used to invoke the parent class constructor. Let's see a simple example:

6-Another example of super keyword where super() is provided by the compiler implicitly.

7-Let's see the real use of super keyword. Here, Emp class inherits Person class so all the properties of Person will be inherited to Emp by default. To initialize all the property, we are using parent class constructor from child class. In such way, we are reusing the parent class constructor.

(final keyword)


1-There is a final variable speedlimit, we are going to change the value of this variable, but It can't be changed because final variable once assigned a value can never be changed.
...
5-It can be initialized only in constructor.
Example of blank final variable

6-Example of static blank final variable
...
1-What is the use of instance initializer block while we can directly assign a value in instance data member? For example:

2-Let's see the simple example of instance initializer block that performs initialization.

3-What is invoked first, instance initializer block or constructor?

4-Program of instance initializer block that is invoked after super()

5-Another example of instance block
...
2-When type of the object is determined at run-time, it is known as dynamic binding.
...
2-In this example, Shape is the abstract class, and its implementation is provided by the Rectangle and Circle classes.

3-In this example, if you create the instance of Rectangle class, draw() method of Rectangle class will be invoked.

4-Another example of Abstract class in java

5-Abstract class having constructor, data member and methods
...
3-Java Interface Example: Drawable

4-In this example, the Drawable interface has only one method. Its implementation is provided by Rectangle and Circle classes. In a real scenario, an interface is defined by someone else, but its implementation is provided by different implementation providers. Moreover, it is used by someone else. The implementation part is hidden by the user who uses the interface.

5-Java Interface Example: Bank
...
7-A class implements an interface, but one interface extends another interface.
